...
def logger(old_function):
    ...
    def new_function(*args, **kwargs):
        with open('log.log', 'w', encoding='utf-8') as log:
            log.write(f"Start date and time: {start}\n")
            log.write(f"KEYWORDS: {args}\n")
            log.write(f"Function's name: {old_function.__name__}\n")
...
def keywords_scrapping(KEYWORDS):
    ...
    for WORD in KEYWORDS:
        for article_tag in article_tags_with_ids:
            ...
            preview_body_tag = article_tag.find('div',
            ...
            if preview_body_tag is not None:
                ...
                preview_body = article_tag.find('div',
